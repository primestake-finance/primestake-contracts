...
// File: contracts/PrimeStakePoolInitializable.sol

pragma solidity 0.6.12;

contract PrimeStakePoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public STEAK_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == STEAK_POOL_FACTORY, "Not factory");
...
// File: contracts/PrimeStakePoolFactory.sol

pragma solidity 0.6.12;

contract PrimeStakePoolFactory is Ownable {
    event NewPrimeStakePoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(PrimeStakePoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        PrimeStakePoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewPrimeStakePoolContract(smartChefAddress);
    }
}
