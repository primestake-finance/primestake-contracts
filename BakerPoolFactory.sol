...
// File: contracts/BakerPoolInitializable.sol

pragma solidity 0.6.12;

contract BakerPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public BAKER_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == BAKER_POOL_FACTORY, "Not factory");
...
// File: contracts/BakerPoolFactory.sol

pragma solidity 0.6.12;

contract BakerPoolFactory is Ownable {
    event NewBakerPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(BakerPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        BakerPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewBakerPoolContract(smartChefAddress);
    }
}
